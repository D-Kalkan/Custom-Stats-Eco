...
namespace Eco.Mods.TechTree
{
    ...
    {
        public override LocString DisplayDescription { get { return Localizer.DoStr("Advanced industrialization to produce larger machines and advanced technology. Levels up by crafting related recipes."); } }
    ...
    public partial class IndustrySkillBookRecipe : RecipeFamily
    {
        public IndustrySkillBookRecipe()
        {
            ...
            recipe.Init(
                "Industry",  //noloc
                Localizer.DoStr("Modern Industry Research Project"),
                new List<IngredientElement>
                {
                    new IngredientElement(typeof(CulinaryResearchPaperAdvancedItem), 100, typeof(MechanicsSkill)),
                    new IngredientElement(typeof(CulinaryResearchPaperModernItem), 50, typeof(MechanicsSkill)),
                    new IngredientElement(typeof(DendrologyResearchPaperAdvancedItem), 100, typeof(MechanicsSkill)),
                    new IngredientElement(typeof(DendrologyResearchPaperModernItem), 150, typeof(MechanicsSkill)),
                    new IngredientElement(typeof(GeologyResearchPaperAdvancedItem), 100, typeof(MechanicsSkill)),
                    new IngredientElement(typeof(GeologyResearchPaperModernItem), 225, typeof(MechanicsSkill)),
                    new IngredientElement(typeof(MetallurgyResearchPaperBasicItem), 75, typeof(MechanicsSkill)),
                    new IngredientElement(typeof(MetallurgyResearchPaperAdvancedItem), 150, typeof(MechanicsSkill)),
                    new IngredientElement(typeof(MetallurgyResearchPaperModernItem), 100, typeof(MechanicsSkill)),
                    ...
                    new IngredientElement(typeof(AgricultureResearchPaperModernItem), 125, typeof(MechanicsSkill)),
                    new IngredientElement("Basic Research", 600, typeof(MechanicsSkill)), //noloc
                    new IngredientElement(typeof(AdvancedSmeltingSkillScroll), 1, typeof(BasicEngineeringSkill)),
                },
                new List<CraftingElement>
                {
                    new CraftingElement<IndustrySkillBook>(),
                    new CraftingElement<IndustrySkillScroll>(100)
                });
            this.Recipes = new List<Recipe> { recipe };
            this.CraftMinutes = CreateCraftTimeValue(1);
            this.ModsPreInitialize();
            this.Initialize(Localizer.DoStr("Modern Research 4: Industry"), typeof(IndustrySkillBookRecipe));
