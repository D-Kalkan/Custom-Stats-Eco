...
namespace Eco.Mods.TechTree
{
    ...
    {
                                                                                                                                                                                                                                           // Static values
        private static IDynamicValue caloriesBurn           = new MultiDynamicValue(MultiDynamicOps.Multiply, new TalentModifiedValue(typeof(SteelSickleItem), typeof(GatheringToolEfficiencyTalent)), CreateCalorieValue(15, typeof(FarmingSkill), typeof(SteelSickleItem)));
