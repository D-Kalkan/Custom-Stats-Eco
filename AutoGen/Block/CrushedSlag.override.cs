...
namespace Eco.Mods.TechTree
{
    ...
    public partial class CrushedSlagRecipe : RecipeFamily
    {
        public CrushedSlagRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                "CrushedSlag",  //noloc
                Localizer.DoStr("Crushed Slag"),
                new List<IngredientElement>
                {
                    new IngredientElement(typeof(SlagItem), 12, true),
                },
                new List<CraftingElement>
                {
                    new CraftingElement<CrushedSlagItem>(3)
                });
            this.Recipes = new List<Recipe> { recipe };
            this.ExperienceOnCraft = 0.5f;
            this.LaborInCalories = CreateLaborInCaloriesValue(200, typeof(MiningSkill));
            this.CraftMinutes = CreateCraftTimeValue(typeof(CrushedSlagRecipe), 1.5f, typeof(MiningSkill));
            this.ModsPreInitialize();
            this.Initialize(Localizer.DoStr("Crushed Slag"), typeof(CrushedSlagRecipe));
