...
namespace Eco.Mods.TechTree
{
    ...
    public partial class FriedHeartsOfPalmItem : FoodItem
    {
        ...
        public override Nutrients Nutrition             => new Nutrients() { Carbs = 8, Fat = 5, Protein = 2, Vitamins = 2};
    }
    ...
    public partial class FriedHeartsOfPalmRecipe : RecipeFamily
    {
        public FriedHeartsOfPalmRecipe()
        {
            ...
            recipe.Init(
                "FriedHeartsOfPalm",  //noloc
                Localizer.DoStr("Fried Hearts Of Palm"),
                new List<IngredientElement>
                {
                    new IngredientElement(typeof(HeartOfPalmItem), 30, typeof(CampfireCookingSkill), typeof(CampfireCookingLavishResourcesTalent)),
