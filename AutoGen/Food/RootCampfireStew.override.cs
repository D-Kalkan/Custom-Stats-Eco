...
namespace Eco.Mods.TechTree
{
    ...
    public partial class RootCampfireStewItem : FoodItem
    {
        ...
        public override Nutrients Nutrition             => new Nutrients() { Carbs = 6, Fat = 12, Protein = 5, Vitamins = 5};
    ...
    public partial class RootCampfireStewRecipe : RecipeFamily
    {
        public RootCampfireStewRecipe()
        {
            ...
            recipe.Init(
                ...
                {
                    new IngredientElement(typeof(BeetItem), 4.5f, typeof(CampfireCookingSkill), typeof(CampfireCookingLavishResourcesTalent)),
