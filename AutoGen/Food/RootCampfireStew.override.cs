...
namespace Eco.Mods.TechTree
{
    ...
    public partial class RootCampfireStewItem : FoodItem
    {
        ...
        public override Nutrients Nutrition             => new Nutrients() { Carbs = 4, Fat = 6, Protein = 6, Vitamins = 4};
    }
    ...
    public partial class RootCampfireStewRecipe : RecipeFamily
    {
        public RootCampfireStewRecipe()
        {
            ...
            recipe.Init(
                "RootCampfireStew",  //noloc
                Localizer.DoStr("Root Campfire Stew"),
                new List<IngredientElement>
                {
                    new IngredientElement(typeof(BeetItem), 15, typeof(CampfireCookingSkill), typeof(CampfireCookingLavishResourcesTalent)),
