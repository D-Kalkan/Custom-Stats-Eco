...
namespace Eco.Mods.TechTree
{
    ...
    public partial class BakedTaroItem : FoodItem
    {
        ...
        public override Nutrients Nutrition             => new Nutrients() { Carbs = 9, Fat = 3, Protein = 7, Vitamins = 13};
    ...
    public partial class BakedTaroRecipe : RecipeFamily
    {
        public BakedTaroRecipe()
        {
            ...
            recipe.Init(
                ...
                {
                    new IngredientElement(typeof(TaroRootItem), 15, typeof(BakingSkill), typeof(BakingLavishResourcesTalent)),
