...
namespace Eco.Mods.TechTree
{
    ...
    public partial class FieldCampfireStewItem : FoodItem
    {
        ...
        public override Nutrients Nutrition             => new Nutrients() { Carbs = 12, Fat = 8, Protein = 4, Vitamins = 4};
    ...
    public partial class FieldCampfireStewRecipe : RecipeFamily
    {
        public FieldCampfireStewRecipe()
        {
            ...
            recipe.Init(
                ...
                {
                    new IngredientElement(typeof(CornItem), 4.5f, typeof(CampfireCookingSkill), typeof(CampfireCookingLavishResourcesTalent)),
                    new IngredientElement(typeof(TomatoItem), 4.5f, typeof(CampfireCookingSkill), typeof(CampfireCookingLavishResourcesTalent)),
