...
namespace Eco.Mods.TechTree
{
    ...
    public partial class InfusedOilRecipe : RecipeFamily
    {
        public InfusedOilRecipe()
        {
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(InfusedOilRecipe), start: 2, skillType: typeof(AdvancedCookingSkill), typeof(AdvancedCookingFocusedSpeedTalent), typeof(AdvancedCookingParallelSpeedTalent));
