...
namespace Eco.Mods.TechTree
{
    ...
    public partial class FriedCamasItem : FoodItem
    {
        ...
        public override Nutrients Nutrition             => new Nutrients() { Carbs = 6, Fat = 7, Protein = 2, Vitamins = 2};
    }
    ...
    public partial class FriedCamasRecipe : RecipeFamily
    {
        public FriedCamasRecipe()
        {
            ...
            recipe.Init(
                ...
                {
                    new IngredientElement(typeof(CamasBulbItem), 30, typeof(CampfireCookingSkill), typeof(CampfireCookingLavishResourcesTalent)),
