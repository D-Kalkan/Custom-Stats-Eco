...
namespace Eco.Mods.TechTree
{
    ...
    public partial class FishNChipsRecipe : RecipeFamily
    {
        public FishNChipsRecipe()
        {
            ...
            this.CraftMinutes = CreateCraftTimeValue(typeof(FishNChipsRecipe), 4, typeof(AdvancedCookingSkill), typeof(AdvancedCookingFocusedSpeedTalent), typeof(AdvancedCookingParallelSpeedTalent));
            this.ModsPreInitialize();
            this.Initialize(Localizer.DoStr("Fish N Chips"), typeof(FishNChipsRecipe));
