...
namespace Eco.Mods.TechTree
{
    ...
    public partial class CharredHeartOfPalmItem : FoodItem
    {
        ...
        public override Nutrients Nutrition             => new Nutrients() { Carbs = 4, Fat = 1, Protein = 2, Vitamins = 2};
    }
    ...
    public partial class CharredHeartOfPalmRecipe : RecipeFamily
    {
        public CharredHeartOfPalmRecipe()
        {
            ...
            recipe.Init(
                "CharredHeartOfPalm",  //noloc
                Localizer.DoStr("Charred Heart Of Palm"),
                new List<IngredientElement>
                {
                    new IngredientElement(typeof(HeartOfPalmItem), 30, true),
                },
