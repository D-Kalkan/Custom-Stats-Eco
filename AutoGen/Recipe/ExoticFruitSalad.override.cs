...
namespace Eco.Mods.TechTree
{
    ...
    public partial class ExoticFruitSaladRecipe : RecipeFamily
    {
        public ExoticFruitSaladRecipe()
        {
            ...
            recipe.Init(
                "ExoticFruitSalad",  //noloc
                Localizer.DoStr("Exotic Fruit Salad"),
                new List<IngredientElement>
                {
                    new IngredientElement(typeof(PricklyPearFruitItem), 18, typeof(CookingSkill), typeof(CookingLavishResourcesTalent)),
                    new IngredientElement(typeof(PumpkinItem), 1, typeof(CookingSkill), typeof(CookingLavishResourcesTalent)),
                },
