...
namespace Eco.Mods.TechTree
{
    ...
    public partial class CampfireMoonJellyfishRecipe : RecipeFamily
    {
        public CampfireMoonJellyfishRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                "CampfireMoonJellyfish",  //noloc
            ...
            this.CraftMinutes = CreateCraftTimeValue(typeof(CampfireMoonJellyfishRecipe), 0.5f, typeof(CampfireCookingSkill), typeof(CampfireCookingFocusedSpeedTalent), typeof(CampfireCookingParallelSpeedTalent));
