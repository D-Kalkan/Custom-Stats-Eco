...
namespace Eco.Mods.TechTree
{
    ...
    public partial class WheatEthanolRecipe : RecipeFamily
    {
        public WheatEthanolRecipe()
        {
            ...
            this.CraftMinutes = CreateCraftTimeValue(typeof(WheatEthanolRecipe), 1, typeof(MillingSkill), typeof(CuttingEdgeCookingFocusedSpeedTalent), typeof(CuttingEdgeCookingParallelSpeedTalent));
            this.ModsPreInitialize();
            this.Initialize(Localizer.DoStr("Wheat Ethanol"), typeof(WheatEthanolRecipe));
