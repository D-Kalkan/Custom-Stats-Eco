...
namespace Eco.Mods.TechTree
{
    ...
    public partial class PulpFillerItem : FertilizerItem<PulpFillerItem>
    {
        ...
        static PulpFillerItem()
        {
            ...
            Nutrients.Add(new NutrientElement("Phosphorus", 0.2f));    // Defines the amount of Phosphorus added by this fertilizer item
            Nutrients.Add(new NutrientElement("Potassium", 0.4f));      // Defines the amount of Potassium added by this fertilizer item
        }
    }
}
