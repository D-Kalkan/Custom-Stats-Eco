...
namespace Eco.Mods.TechTree
{
    ...
    {
        public override LocString DisplayDescription { get; } = Localizer.DoStr("Lowers the tier requirement of related tables by 0.2.(Only applies to claimed workstations)");
