...
namespace Eco.Mods.TechTree
{
    ...
    public partial class WoodenKitchenLampRecipe : RecipeFamily
    {
        public WoodenKitchenLampRecipe()
        {
            ...
            recipe.Init(
                "WoodenKitchenLamp",  //noloc
                Localizer.DoStr("Wooden Kitchen Lamp"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(typeof(WoodenKitchenLampRecipe), 4, typeof(CarpentrySkill), typeof(CarpentryFocusedSpeedTalent), typeof(CarpentryParallelSpeedTalent));
            this.ModsPreInitialize();
            this.Initialize(Localizer.DoStr("Wooden Kitchen Lamp"), typeof(WoodenKitchenLampRecipe));
            this.ModsPostInitialize();
